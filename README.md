...
Варианты вызова:
    ...
    2. *./JitCompiler <число>* - вызов машинного кода, соответсвующего изменённой версии функции *return_value*. Вместо 42 она будет возвращать переданное программе в качестве аргумента *<число>*
