...
### Замечания по сборке
С помощью shell-скрипта *compile_for_gdb.sh* можно скомпилировать файл *return_value.cpp* таки образом, чтобы информация о машинном коде функции *return_value* была доступна для gdb.

С помощью shell-скрипта *gdb.sh* можно вывести информацию о машинном и ассемблерном коде  *return_value* функции на экран.
